...
Static::Static(std::string name, Textures* tex, EntityManager* entityManager, iPoint position) : Entity(EntityType::STATIC)
{
	...
	else if (name == "stone_2")
	{
		type = Static::Type::STONE;
		SetRect(194, 25, 28, 14);
		SetPivot(14, 14);
	}
	else if (name == "stone_3")
	{
		type = Static::Type::STONE;
		SetRect(256, 143, 32, 17);
		SetPivot(16, 17);
	}
	else if (name == "cemetery_door")
	{
		type = Static::Type::DOOR;
		SetRect(0, 229, 32, 27);
		SetPivot(16, 27);
	}
	else if (name == "cemetery_door2")
	{
		type = Static::Type::DOOR;
		SetRect(32, 234, 32, 22);
		SetPivot(16, 22);
	}
	else if (name == "cemetery_door3")
	{
		type = Static::Type::DOOR;
		SetRect(65, 229, 32, 27);
		SetPivot(16, 27);
	}
	else if (name == "roof_red")
	{
		type = Static::Type::ROOF;
		SetRect(416, 236, 32, 20);
		SetPivot(64, 80);
	}
	else if (name == "roof_red2")
	{
		type = Static::Type::ROOF;
		SetRect(448, 236, 32, 20);
		SetPivot(64, 80);
	}
	else if (name == "roof_red3")
	{
		type = Static::Type::ROOF;
		SetRect(480, 236, 32, 20);
		SetPivot(64, 80);
	}
	else if (name == "roof_red4")
	{
		type = Static::Type::ROOF;
		SetRect(416, 256, 32, 32);
		SetPivot(64, 64);
	}
	else if (name == "roof_red5")
	{
		type = Static::Type::ROOF;
		SetRect(448, 256, 32, 32);
		SetPivot(64, 64);
	}
	else if (name == "roof_red6")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "antenna_2")
	{
		type = Static::Type::ANTENNA;
		SetRect(167, 14, 15, 18);
		SetPivot(8, 54);
	}
	else if (name == "roof_green")
	{
		type = Static::Type::ROOF;
		SetRect(416, 12, 32, 20);
		SetPivot(16, 20);
	}
	else if (name == "roof_green2")
	{
		type = Static::Type::ROOF;
		SetRect(448, 12, 32, 20);
		SetPivot(16, 20);
	}
	else if (name == "roof_green3")
	{
		type = Static::Type::ROOF;
		SetRect(448, 12, 32, 20);
		SetPivot(16, 20);
	}
	else if (name == "roof_green4")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "roof_green6")
	{
		type = Static::Type::ROOF;
		SetRect(416, 32, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "cup_city")
	{
		type = Static::Type::CUP;
		SetRect(73, 203, 14, 11);
		SetPivot(7, 22);
	}
	else if (name == "machine_city")
	{
		type = Static::Type::MACHINE;
		SetRect(210, 150, 14, 38);
		SetPivot(7, 38);
	}
	else if (name == "signal_city")
	{
		type = Static::Type::SIGNAL;
		SetRect(169, 32, 15, 40);
		SetPivot(8, 40);
	}
	else if (name == "tree_city")
	{
		type = Static::Type::TREE;
	...
	else if (name == "roof_res")
	{
		type = Static::Type::ROOF;
		SetRect(353, 322, 31, 30);
		SetPivot(16, 60);
	}
	else if (name == "roof_res2")
	{
		type = Static::Type::ROOF;
		SetRect(385, 322, 32, 30);
		SetPivot(16, 60);
	}
	else if (name == "roof_res3")
	{
		type = Static::Type::ROOF;
		SetRect(417, 322, 32, 30);
		SetPivot(16, 60);
	}
	else if (name == "roof_res4")
	{
		type = Static::Type::ROOF;
		SetRect(449, 322, 32, 30);
		SetPivot(16, 60);
	}
	else if (name == "roof_res5")
	{
		type = Static::Type::ROOF;
		SetRect(481, 321, 32, 31);
		SetPivot(16, 60);
	}
	else if (name == "roof_res6")
	{
		type = Static::Type::ROOF;
		SetRect(353, 352, 32, 32);
		SetPivot(16, 60);
	}
	else if (name == "roof_res7")
	{
		type = Static::Type::ROOF;
		SetRect(385, 352, 32, 32);
		SetPivot(16, 60);
	}
	else if (name == "roof_res8")
	{
		type = Static::Type::ROOF;
		SetRect(417, 352, 32, 32);
		SetPivot(16, 60);
	}
	else if (name == "roof_res9")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "door_res")
	{
		type = Static::Type::DOOR;
		SetRect(352, 192, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "door_res2")
	{
		type = Static::Type::DOOR;
		SetRect(96, 122, 32, 6);
		SetPivot(16, 24);
	}
	else if (name == "door_res3")
	{
		type = Static::Type::DOOR;
		SetRect(96, 192, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "door_res4")
	{
		type = Static::Type::DOOR;
	...
	else if (name == "chair_3")
	{
		type = Static::Type::FURNITURE;
		SetRect(264, 232, 17, 22);
		SetPivot(9, 22);
	}
	else if (name == "res_table")
	{
		type = Static::Type::TABLE;
		SetRect(98, 34, 30, 29);
		SetPivot(128, 116);
	}
	else if (name == "res_table2")
	{
		type = Static::Type::TABLE;
		SetRect(128, 37, 31, 26);
		SetPivot(124, 104);
	}
	else if (name == "res_cupboard")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "plate_2")
	{
		type = Static::Type::PLATE;
		SetRect(169, 363, 23, 9);
		SetPivot(92, 36);
	}
	else if (name == "plate_3")
	{
		type = Static::Type::PLATE;
	...
	else if (name == "lamp_city2")
	{
		type = Static::Type::LAMP;
		SetRect(1092, 64, 24, 32);
		SetPivot(12, 64);
	}
	else if (name == "lamp_city3")
	{
		type = Static::Type::LAMP;
		SetRect(1098, 32, 12, 23);
		SetPivot(6, 23);
	}
	else if (name == "lamp_city4")
	{
		type = Static::Type::LAMP;
		SetRect(1092, 0, 24, 32);
		SetPivot(12, 32);
	}
	else if (name == "roof_city")
	{
		type = Static::Type::ROOF;
		SetRect(416, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city2")
	{
		type = Static::Type::ROOF;
		SetRect(448, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city3")
	{
		type = Static::Type::ROOF;
		SetRect(480, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city4")
	{
		type = Static::Type::ROOF;
		SetRect(416, 256, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city5")
	{
		type = Static::Type::ROOF;
		SetRect(448, 256, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city6")
	{
		type = Static::Type::ROOF;
		SetRect(480, 256, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city7")
	{
		type = Static::Type::ROOF;
		SetRect(416, 224, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city8")
	{
		type = Static::Type::ROOF;
		SetRect(448, 224, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city9")
	{
		type = Static::Type::ROOF;
		SetRect(480, 224, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city10")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "roof_city12")
	{
		type = Static::Type::ROOF;
		SetRect(384, 128, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city13")
	{
		type = Static::Type::ROOF;
		SetRect(256, 160, 32, 32);
		SetPivot(16, 128);
	}
	else if (name == "roof_city14")
	{
		type = Static::Type::ROOF;
		SetRect(384, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city15")
	{
		type = Static::Type::ROOF;
		SetRect(320, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city16")
	{
		type = Static::Type::ROOF;
		SetRect(384, 192, 32, 32);
		SetPivot(16, 64);
	}
	else if (name == "roof_city17")
	{
		type = Static::Type::ROOF;
		SetRect(512, 0, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city18")
	{
		type = Static::Type::ROOF;
		SetRect(544, 0, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city19")
	{
		type = Static::Type::ROOF;
		SetRect(576, 0, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city20")
	{
		type = Static::Type::ROOF;
		SetRect(512, 64, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city21")
	{
		type = Static::Type::ROOF;
		SetRect(544, 64, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city22")
	{
		type = Static::Type::ROOF;
		SetRect(576, 64, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "roof_city23")
	{
		type = Static::Type::ROOF;
	...
	else if (name == "furniture_2")
	{
		type = Static::Type::FURNITURE;
		SetRect(992, 160, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "furniture_3")
	{
		type = Static::Type::FURNITURE;
		SetRect(992, 128, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "furniture_4")
	{
		type = Static::Type::FURNITURE;
		SetRect(708, 68, 28, 28);
		SetPivot(14, 28);
	}
	else if (name == "furniture_5")
	{
		type = Static::Type::FURNITURE;
		SetRect(736, 69, 22, 28);
		SetPivot(11, 28);
	}
	else if (name == "furniture_6")
	{
		type = Static::Type::FURNITURE;
		SetRect(712, 97, 24, 28);
		SetPivot(12, 28);
	}
	else if (name == "furniture_7")
	{
		type = Static::Type::FURNITURE;
		SetRect(736, 97, 20, 31);
		SetPivot(10, 31);
	}
	else if (name == "furniture_8")
	{
		type = Static::Type::FURNITURE;
		SetRect(960, 113, 32, 15);
		SetPivot(32, 60);
	}
	else if (name == "furniture_9")
	{
		type = Static::Type::FURNITURE;
	...
	else if (name == "furniture_11")
	{
		type = Static::Type::FURNITURE;
		SetRect(960, 70, 32, 26);
		SetPivot(32, 104);
	}
	else if (name == "furniture_12")
	{
		type = Static::Type::FURNITURE;
		SetRect(809, 256, 15, 30);
		SetPivot(15, 240);
	}
	else if (name == "furniture_13")
	{
		type = Static::Type::FURNITURE;
		SetRect(963, 12, 27, 20);
		SetPivot(27, 80);
	}
	else if (name == "furniture_14")
	{
		type = Static::Type::FURNITURE;
		SetRect(722, 4, 14, 28);
		SetPivot(14, 112);
	}
	else if (name == "furniture_15")
	{
		type = Static::Type::FURNITURE;
		SetRect(724, 32, 12, 26);
		SetPivot(12, 104);
	}
	else if (name == "furniture_16")
	{
		type = Static::Type::FURNITURE;
	...
	else if (name == "furniture_18")
	{
		type = Static::Type::FURNITURE;
		SetRect(896, 416, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "furniture_19")
	{
		type = Static::Type::FURNITURE;
	...
	else if (name == "furniture_21")
	{
		type = Static::Type::FURNITURE;
		SetRect(898, 16, 28, 16);
		SetPivot(28, 64);
	}
	else if (name == "furniture_22")
	{
		type = Static::Type::FURNITURE;
		SetRect(896, 32, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "furniture_23")
	{
		type = Static::Type::FURNITURE;
		SetRect(864, 288, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "furniture_24")
	{
		type = Static::Type::FURNITURE;
		SetRect(896, 288, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "furniture_25")
	{
		type = Static::Type::FURNITURE;
		SetRect(874, 480, 22, 15);
		SetPivot(22, 60);
	}
	else if (name == "furniture_26")
	{
		type = Static::Type::FURNITURE;
		SetRect(896, 480, 21, 15);
		SetPivot(21, 60);
	}
	else if (name == "furniture_27")
	{
		type = Static::Type::FURNITURE;
		SetRect(768, 416, 32, 32);
		SetPivot(32, 128);
	}
	else if (name == "furniture_28")
	{
		type = Static::Type::FURNITURE;
		SetRect(832, 416, 32, 32);
		SetPivot(32, 256);
	}
	else if (name == "furniture_29")
	{
		type = Static::Type::FURNITURE;
		SetRect(968, 32, 17, 32);
		SetPivot(17, 128);
	}
	else if (name == "furniture_30")
	{
		type = Static::Type::FURNITURE;
	...
	else if (name == "fence_2")
	{
		type = Static::Type::FENCE;
		SetRect(1056, 366, 32, 18);
		SetPivot(16, 18);
	}
	else if (name == "fence_3")
	{
		type = Static::Type::FENCE;
		SetRect(1088, 366, 32, 18);
		SetPivot(16, 18);
	}
	else if (name == "fence_4")
	{
		type = Static::Type::FENCE;
		SetRect(1024, 366, 32, 18);
		SetPivot(16, 18);
	}
	else if (name == "fence_5")
	{
		type = Static::Type::FENCE;
		SetRect(1216, 384, 32, 32);
		SetPivot(16, 32);
	}
	else if (name == "fence_6")
	{
		type = Static::Type::FENCE;
	...
	else if (name == "res_city_roof")
	{
		type = Static::Type::ROOF;
		SetRect(2100, 424, 160, 32);
		SetPivot(80, 32);
	}
	else if (name == "roof_osaka")
	{
		type = Static::Type::ROOF;
		SetRect(32, 32, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka2")
	{
		type = Static::Type::ROOF;
		SetRect(64, 32, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka3")
	{
		type = Static::Type::ROOF;
		SetRect(32, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka4")
	{
		type = Static::Type::ROOF;
		SetRect(384, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka5")
	{
		type = Static::Type::ROOF;
		SetRect(416, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka6")
	{
		type = Static::Type::ROOF;
		SetRect(448, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka7")
	{
		type = Static::Type::ROOF;
		SetRect(544, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka8")
	{
		type = Static::Type::ROOF;
		SetRect(576, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka9")
	{
		type = Static::Type::ROOF;
		SetRect(608, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka10")
	{
		type = Static::Type::ROOF;
		SetRect(544, 64, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka11")
	{
		type = Static::Type::ROOF;
		SetRect(577, 64, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka12")
	{
		type = Static::Type::ROOF;
		SetRect(608, 64, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka13")
	{
		type = Static::Type::ROOF;
		SetRect(128, 96, 32, 32);
		SetPivot(64, 64);
	}
	else if (name == "roof_osaka14")
	{
		type = Static::Type::ROOF;
		SetRect(480, 0, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka15")
	{
		type = Static::Type::ROOF;
		SetRect(96, 32, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "roof_osaka16")
	{
		type = Static::Type::ROOF;
		SetRect(96, 64, 32, 32);
		SetPivot(32, 64);
	}
	else if (name == "osaka_furniture")
	{
		type = Static::Type::FURNITURE;
		SetRect(363, 13, 15, 13);
		SetPivot(15, 52);
	}
	else if (name == "osaka_furniture2")
	{
		type = Static::Type::FURNITURE;
		SetRect(289, 17, 30, 15);
		SetPivot(30, 60);
	}
	else if (name == "osaka_furniture3")
	{
		type = Static::Type::FURNITURE;
		SetRect(289, 32, 30, 21);
		SetPivot(30, 84);
	}
	else if (name == "osaka_furniture4")
	{
		type = Static::Type::FURNITURE;
	...
	else if (name == "osaka_light")
	{
		type = Static::Type::LIGHT;
		SetRect(519, 229, 18, 81);
		SetPivot(9, 81);
	}
	else if (name == "osaka_light2")
	{
		type = Static::Type::LIGHT;
		SetRect(106, 239, 20, 44);
		SetPivot(10, 44);
	}
	else if (name == "osaka_light3")
	{
		type = Static::Type::LIGHT;
		SetRect(130, 239, 20, 44);
		SetPivot(10, 44);
	}
	else if (name == "osaka_fence")
	{
		type = Static::Type::FENCE;
		SetRect(161, 271, 30, 17);
		SetPivot(15, 17);
	}
	else if (name == "machine_osaka")
	{
		type = Static::Type::MACHINE;
		SetRect(491, 137, 21, 23);
		SetPivot(11, 23);
	}
	else if (name == "machine_osaka2")
	{
		type = Static::Type::MACHINE;
		SetRect(491, 160, 21, 7);
		SetPivot(11, 7);
	}
	else if (name == "machine_osaka3")
	{
		type = Static::Type::MACHINE;
		SetRect(517, 139, 21, 21);
		SetPivot(11, 21);
	}
	else if (name == "machine_osaka4")
	{
		type = Static::Type::MACHINE;
	...
	else if (name == "office_drawer_1")
	{
	type = Static::Type::FURNITURE;
	SetRect(1679, 363, 17, 35);
	SetPivot(9, 35);
	}
	else if (name == "office_drawer_2")
	{
	type = Static::Type::FURNITURE;
	SetRect(1704, 362, 16, 36);
	SetPivot(8, 36);
	}
	else if (name == "office_drawer_3")
	{
	type = Static::Type::FURNITURE;
	SetRect(1632, 299, 27, 35);
	SetPivot(14, 35);
	}
	else if (name == "office_box")
	{
	type = Static::Type::FURNITURE;
	SetRect(1959, 395, 21, 16);
	SetPivot(11, 16);
	}
	else if (name == "office_wallet")
	{
	type = Static::Type::FURNITURE;
	SetRect(1895, 489, 18, 15);
	SetPivot(9, 15);
	}
	else if (name == "office_printer")
	{
	type = Static::Type::FURNITURE;
	SetRect(1484, 416, 42, 30);
	SetPivot(21, 30);
	}
	else if (name == "office_chair_1")
	{
	type = Static::Type::FURNITURE;
	SetRect(1830, 482, 17, 26);
	SetPivot(9, 26);
	}
	else if (name == "office_chair_2")
	{
	type = Static::Type::FURNITURE;
